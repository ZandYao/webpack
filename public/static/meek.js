(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory() } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports['Datatang'] = factory() } else { root['Datatang'] = factory() }
})(this, function() {
  ...
  /******/ ([
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _square = __webpack_require__(22)
      ...
      var _imagestate = __webpack_require__(31)

      var _imageevent = __webpack_require__(32)

      var _singleimage = __webpack_require__(34)
      ...
      var _singleimagelayer = __webpack_require__(39)
      ...
      var _drawevent = __webpack_require__(45)
      ...
      var _geojson = __webpack_require__(81)

      var _geojson2 = _interopRequireDefault(_geojson)

      var _intersects = __webpack_require__(82)

      var _intersects2 = _interopRequireDefault(_intersects)

      var _splitpolygon = __webpack_require__(83)
      ...
      var _polygonwithhole = __webpack_require__(85)
	 ...
	 */
	  ...
	  var toleranceDistance = tolerance || 2
	 ...
	 * @returns {Array}
	 */
      ExtentUtil.updateSquare = function (geometry, newCoordinates, dragSegments) {
	  var dragSegment = dragSegments[0]
	  var index = dragSegment.index
	  var extentCoordinates = geometry.getCoordinates()
	  var segment1 = extentCoordinates[index]
	  ...
	  if (isVertex) {
	    var squareCoordinates = ExtentUtil.genSquareCoordinates([extentCoordinates[(index + 2) % 4], newCoordinates], true)
	    if (index === 0 || index === 4) {
	      extentCoordinates[0] = squareCoordinates[1]
	      extentCoordinates[4] = squareCoordinates[1]
	      extentCoordinates[1][1] = squareCoordinates[1][1]
	      extentCoordinates[3][0] = squareCoordinates[1][0]
	    } else if (index === 1) {
	      extentCoordinates[1] = squareCoordinates[1]
	      extentCoordinates[2][0] = squareCoordinates[1][0]
	      extentCoordinates[0][1] = squareCoordinates[1][1]
	      extentCoordinates[4] = extentCoordinates[0]
	    } else if (index === 2) {
	      extentCoordinates[2] = squareCoordinates[1]
	      extentCoordinates[1][0] = squareCoordinates[1][0]
	      extentCoordinates[3][1] = squareCoordinates[1][1]
	    } else if (index === 3) {
	      extentCoordinates[3] = squareCoordinates[1]
	      extentCoordinates[2][1] = squareCoordinates[1][1]
	      extentCoordinates[0][0] = squareCoordinates[1][0]
	      extentCoordinates[4] = extentCoordinates[0]
	    }
	  } else {
	    if (segment1[0] === segment2[0]) {
	      // x轴相等 index = 1 or 3
	      var delta = newCoordinates[0] - extentCoordinates[index][0]
	      extentCoordinates[index][0] = newCoordinates[0]
	      extentCoordinates[(index + 1) % 4][0] = newCoordinates[0]
	      extentCoordinates[(index + 1) % 4][1] += delta
	      extentCoordinates[(index + 2) % 4][1] += delta
	    }

	    if (segment1[1] === segment2[1]) {
	      // y轴相等 index = 0 or 2
	      var _delta = newCoordinates[1] - extentCoordinates[index][1]
	      extentCoordinates[index][1] = newCoordinates[1]
	      extentCoordinates[index + 1][1] = newCoordinates[1]
	      extentCoordinates[index + 1][0] -= _delta
	      extentCoordinates[(index + 2) % 4][0] -= _delta
	    }
	 ...
	 */
	  ...
	  var intersection = opt_extent || ExtentUtil.createEmpty()
	 ...
	 *
	 * @param coordinates
	 * @param getMax 计算使用最大delta
	 */
      ExtentUtil.genSquareCoordinates = function (coordinates) {
	  var getMax = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false

	  var first = coordinates[0]
	  var last = coordinates[1]
	  var deltaX = last[0] - first[0]
	  var deltaY = last[1] - first[1]
	  var delta = Math[getMax ? 'max' : 'min'](Math.abs(deltaX), Math.abs(deltaY))
	  last[0] = first[0] + (deltaX >= 0 ? delta : -delta)
	  last[1] = first[1] + (deltaY >= 0 ? delta : -delta)
	  return coordinates
      }
	 ...
	 */
	  ...
	  if (!Style._default) {
	    ...
	    Style._default[_geometry2.default.SQUARE] = Style._default[_geometry2.default.EXTENT]
	    ...
	    // 点样式 point style
	    Style._default[_geometry2.default.POINT] = [new _pointstyle2.default(7, white, 1, new _linestyle2.default(blue, 1, width))]
	  }
	 ...
	 */
	  ...
	  styles[_geometry2.default.SQUARE] = styles[_geometry2.default.EXTENT]
	  ...
	  // 点样式
	  styles[_geometry2.default.POINT] = [new _pointstyle2.default(7, white, 0.1, new _linestyle2.default(blue, 1, 2))]
	 ...
	 */
	  ...
	  // 点样式
	  styles[_geometry2.default.POINT] = [new _pointstyle2.default(7, blue, 1, new _linestyle2.default(blue, 1, 1))]
	  styles[_geometry2.default.MULTI_POINT] = styles[_geometry2.default.POINT]
	  ...
	  if (listeners) {
	    ...
	    if (listenerMap) {
	      ...
	      if (Object.keys(listenerMap).length === 0) {
	        Reflect.deleteProperty(target, listenerMap)
	      }
	    }
	  }
      }
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function _inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass) } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass } /**
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * Created by luxueyan on 2018/05/02.
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */
	 ...
	 * @example
	 *
	 *  var rect = new Datatang.Square(10, 10, 500, 500)
	 */
      var Square = (function (_Extent) {
	  _inherits(Square, _Extent)
	  ...
	  function Square() {
	    ...
	    return _possibleConstructorReturn(this, _Extent.call(this, xmin, ymin, xmax, ymax))
	  }
	  ...
	  _createClass(Square, [{
	    key: 'geometryType',
	    get: function get() {
	      return _geometry2.default.SQUARE
	    }
	  }])
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _baseevent = __webpack_require__(33)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _baseimage = __webpack_require__(35)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _baselayer = __webpack_require__(37)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _domutil = __webpack_require__(40)
	 ...
	 */
	  ...
	  Draw.prototype._geometryFactory = function _geometryFactory() {
	    ...
	    } else if (mode === Draw.DrawMode.SQUARE) {
	      Constructor = _square2.default
	  ...
	  Draw.prototype._initGeometryFunction = function _initGeometryFunction() {
	    ...
	    var geometryFunction = function geometryFunction(coordinates, opt_geometry) {
	      ...
	      if (geometry) {
	        ...
	        } else if (mode === Draw.DrawMode.EXTENT || mode === Draw.DrawMode.SQUARE) {
	  ...
	  Draw.prototype._startDrawing = function _startDrawing(event) {
	    ...
	    if (_drawMode === Draw.DrawMode.POINT) {
	      ...
	      if (_drawMode === Draw.DrawMode.EXTENT || _drawMode === Draw.DrawMode.SQUARE) {
	  ...
	  Draw.prototype._modifyDrawing = function _modifyDrawing(event) {
	    ...
	    if (mode === Draw.DrawMode.POINT) {
	      ...
	      last[0] = coordinate[0]
	      last[1] = coordinate[1]
	      if (mode === Draw.DrawMode.SQUARE) {
	        // 正方形限制边长
	        coordinates = _extentutil.ExtentUtil.genSquareCoordinates(coordinates)
	      }
	    }
	    ...
	    if (mode === Draw.DrawMode.EXTENT || mode === Draw.DrawMode.SQUARE) {
	      if (!this._sketchLine) {
	  ...
	  Draw.prototype._atFinish = function _atFinish(event) {
	    ...
	    if (this._sketchFeature) {
	      ...
	      if (drawMode === Draw.DrawMode.LINE) {
	        ...
	        at = this._sketchCoords[0].length === 5
	      }
	 ...
	 */
	  ...
	  switch (type) {
	    ...
	    case _geometry2.default.EXTENT:
	      ...
	      break
	    case _geometry2.default.SQUARE:
	      drawMode = Draw.DrawMode.SQUARE
	      break
	  ...
	  _createClass(Feature, [{
	    ...
	    set: function set(value) {
	      ...
	      if (this._styleHighLight) {
	        ...
	        } else if (geometryType === _geometry2.default.POLYGON || geometryType === _geometry2.default.MULTI_POLYGON || geometryType === _geometry2.default.PARALLELOGRAM || geometryType === _geometry2.default.EXTENT || geometryType === _geometry2.default.SQUARE) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _mousekey = __webpack_require__(51)
	 ...
	 */
	  ...
	  function Modify() {
	     ...
	     * @private
	     */
	    _this._movableGeometrys = options.movableGeometrys ? options.movableGeometrys : [_geometry2.default.EXTENT, _geometry2.default.SQUARE]
	      ...
	      for (var i = 0; i < len; ++i) {
	        ...
	        switch (geometry.geometryType) {
	          ...
	          case _geometry2.default.EXTENT:
	            ...
	            break
	          case _geometry2.default.SQUARE:
	            coordinates = _extentutil.ExtentUtil.updateSquare(geometry, vertex, dragSegment)
	            break
	          case _geometry2.default.MULTI_POLYGON:
	            coordinates = geometry.getCoordinates()
	  ...
	  Modify.prototype._getInExtent = function _getInExtent(features, pixelCoordinate, tolarance) {
	    ...
	    features.forEach(function (feature) {
	      ...
	      if (_ExtentUtil.containsPoint(bufferExtent, pixelCoordinate)) {
	        ...
	        } else if (geometryType === _geometry2.default.EXTENT || geometryType === _geometry2.default.SQUARE || geometryType === _geometry2.default.LINE) {
	  ...
	  _createClass(Modify, [{
	    ...
	    set: function set() {
	      ...
	      this._hasMoveableGeometrys = value.length !== 0
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _canvasrenderer = __webpack_require__(57)

      var _canvasrenderer2 = _interopRequireDefault(_canvasrenderer)

      var _browsereventhandler = __webpack_require__(70)
      ...
      var _componentdefaults = __webpack_require__(72)

      var _controldefaults = __webpack_require__(77)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _featurelayerrenderer = __webpack_require__(59)

      var _featurelayerrenderer2 = _interopRequireDefault(_featurelayerrenderer)

      var _imagelayerrenderer = __webpack_require__(67)
      ...
      var _rendereventtype = __webpack_require__(68)

      var _array = __webpack_require__(26)

      var _renderevent = __webpack_require__(69)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      FeatureLayerRenderer.GeometryRender['square'] = _polygonrender2.default
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _geomertyrender = __webpack_require__(63)
	  ...
	  LineRender.prototype.render = function render(feature, renderStyle, transform) {
	    ...
	    for (var i = 0; i < len; i++) {
	      ...
	      var renderOptions = {
	        ...
	        hasDash: styleObj.style === _linestyle2.default.DASH
	      }
    ...
    /***/ function(module, exports, __webpack_require__) {
	  ...
	  PolygonRender.prototype.render = function render(feature, renderStyle, transform) {
	    ...
	    if (geometry.geometryType === _geometry2.default.EXTENT || geometry.geometryType === _geometry2.default.SQUARE) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _kinetic = __webpack_require__(73)
      ...
      var _keyboardhome = __webpack_require__(74)

      var _keyboardhome2 = _interopRequireDefault(_keyboardhome)

      var _keyboardzoom = __webpack_require__(75)

      var _keyboardzoom2 = _interopRequireDefault(_keyboardzoom)

      var _keyboardpan = __webpack_require__(76)
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _zoompercentage = __webpack_require__(79)
	    ...
	    featuresObj.forEach(function (featureObj) {
	      if (featureObj.type === 'Feature') {
	        if (featureObj.geometry) {
	          ...
	          } else if (geometryType === 'SquarePolygon') {
	            _constructor = _square2.default
	 ...
	 */
	  ...
	  if (polyGeometryType === _geometry2.default.POLYGON || polyGeometryType === _geometry2.default.MULTI_POLYGON || polyGeometryType === _geometry2.default.EXTENT || polyGeometryType === _geometry2.default.SQUARE) {
